      ...
      {weeklyStats.totalTrades === 0 ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <PremiumCard className={`p-4 ${weeklyStats.totalPnl > 0
              ...
              <div className={`text-2xl font-bold ${weeklyStats.totalPnl > 0
                ? 'text-neon-green'
                : weeklyStats.totalPnl < 0
                  ? 'text-neon-red'
                  : ''
            ...
            <PremiumCard className="p-4 bg-muted/20">
              ...
              <div className={`text-2xl font-bold ${weeklyStats.winRate >= 70 ? 'text-neon-green' : ''
                }`}>
