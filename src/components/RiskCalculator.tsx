...
import { Shield, AlertTriangle, CheckCircle2, ThumbsUp } from 'lucide-react';
    ...
    <PremiumCard className="p-6 bg-card border-border">
      ...
      <Tabs defaultValue="position" className="space-y-4">
        ...
        <TabsContent value="position" className="space-y-4">
          ...
          {positionCalc && (
            <PremiumCard className="p-4 bg-gradient-to-br from-primary/10 to-transparent border-primary/30 mt-4">
            ...
            <PremiumCard className="p-4 bg-gradient-to-br from-primary/10 to-transparent border-primary/30 mt-4">
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-border">
                  ...
                  <Badge
                    className={`text-lg ${rrCalc.ratio >= 2
