...
export const RealtimePortfolioTracker = () => {
  ...
  return (
    <div className="space-y-6">
      <PremiumCard className="p-6 bg-gradient-to-br from-primary/10 to-primary/5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {analytics.bestPerformer && (
          <PremiumCard className="p-6 bg-success/5 border-success/20">
        ...
        {analytics.worstPerformer && (
          <PremiumCard className="p-6 bg-destructive/5 border-destructive/20">
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
