...
export const AdvancedAnalytics = ({ trades, initialInvestment, userId, onInitialInvestmentUpdate }: AdvancedAnalyticsProps) => {
  ...
  const StatCard = ({ title, value, subtitle, icon: Icon, trend }: any) => (
    <PremiumCard className="p-6 bg-card border-border hover:border-foreground/20 transition-all duration-300">
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <PremiumCard className="p-8 bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20 mb-6">
              ...
              {brokerFeeData.length > 0 ? brokerFeeData.map((data, index) => (
                <div key={data.broker} className="flex items-center justify-between p-4 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                  <div className="flex items-center gap-4 flex-1">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm ${index === 0 ? 'bg-yellow-500/20 text-yellow-500 border-2 border-yellow-500' :
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <PremiumCard className="p-6 bg-card border-border relative overflow-hidden">
            ...
            <div className="space-y-3">
              {topDaysByROI.length > 0 ? topDaysByROI.map((stat, index) => (
                <div key={stat.day} className="flex items-center justify-between p-3 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                  ...
                  <div className="text-right">
                    <p className={`text-lg font-bold ${stat.avgROI > 0 ? 'text-neon-green' :
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {/* Most Traded Asset */}
          <PremiumCard className="p-5 bg-gradient-to-br from-card to-muted/20 border-border hover:border-primary/50 transition-all duration-300 group">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
          ...
          {/* Most Wins Asset */}
          <PremiumCard className="p-5 bg-gradient-to-br from-card to-neon-green/5 border-border hover:border-neon-green/50 transition-all duration-300 group">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
          ...
          <PremiumCard className="p-5 bg-gradient-to-br from-card to-neon-red/5 border-border hover:border-neon-red/50 transition-all duration-300 group">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
