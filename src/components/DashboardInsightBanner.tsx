...
export const DashboardInsightBanner = ({ totalPnL, winRate, totalTrades }: DashboardInsightBannerProps) => {
  ...
  return (
    <PremiumCard className="border-primary/20 bg-primary/5 backdrop-blur-sm max-w-5xl mx-auto">
      <div className="p-4">
            ...
            >
              ...
              <div className="px-3 py-2 rounded-lg bg-card/50 border border-border/50 group-hover:border-primary/50 transition-colors">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className={`flex items-center gap-1 text-xs ${lsrData.change24h >= 0 ? 'text-profit' : 'text-loss'
                    }`}>
                    {lsrData.change24h >= 0 ? (
              ...
              <div className="px-3 py-2 rounded-lg bg-card/50 border border-border/50 group-hover:border-primary/50 transition-colors">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className={`flex items-center gap-1 text-xs ${lsrData.openInterestChange24h >= 0 ? 'text-profit' : 'text-loss'
                    }`}>
