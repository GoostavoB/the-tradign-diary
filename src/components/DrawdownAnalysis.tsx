...
const DrawdownAnalysisComponent = ({ trades, initialInvestment }: DrawdownAnalysisProps) => {
  ...
  return (
    <PremiumCard className="p-6 bg-gradient-to-br from-card via-card to-card/50 border-border shadow-xl">
      <div className="mb-6">
      ...
      {initialInvestment === 0 ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <PremiumCard className={`p-6 relative overflow-hidden border-2 transition-all duration-300 hover:scale-105 ${currentDrawdown
              ...
              <div className="relative">
                ...
                <div className={`text-4xl font-black mb-2 ${currentDrawdown ? 'text-secondary' : 'text-foreground'
                  }`}>
                  {currentDrawdown ? '-' : ''}<BlurredPercent value={currentDrawdown?.drawdownPercent || 0} />
                </div>
                <div className="flex items-center gap-2">
                  <div className={`px-2 py-0.5 rounded-full text-xs font-semibold ${currentDrawdown
            ...
            <PremiumCard className={`p-6 relative overflow-hidden border-2 transition-all duration-300 hover:scale-105 ${maxDrawdown && maxDrawdown.drawdownPercent > 20
                ? 'bg-gradient-to-br from-secondary/20 via-secondary/10 to-transparent border-secondary/40 shadow-lg shadow-secondary/20'
          ...
          {currentDrawdown && (
            <PremiumCard className="p-6 bg-gradient-to-br from-secondary/20 via-secondary/10 to-transparent border-2 border-secondary/40 mb-6 shadow-xl shadow-secondary/10">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="space-y-3">
                {drawdowns.slice(0, 5).map((dd, index) => (
                  <PremiumCard key={index} className="p-5 bg-gradient-to-br from-card via-card/90 to-card/70 border-border/50 hover:border-border transition-all duration-300 hover:shadow-lg">
          ...
          <PremiumCard className="p-6 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-primary/30 mt-6">
