            ...
            <>
              ...
              <div className="space-y-3">
                {setupPerformance.map((perf, idx) => (
                  <PremiumCard
                    key={perf.name}
                    className={`p-4 transition-all duration-300 ${perf.totalPnl > 0
                    ...
                    {perf.totalTrades > 0 ? (
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div>
                          ...
                          <div className={`text-lg font-bold ${perf.totalPnl > 0 ? 'text-neon-green' : 'text-neon-red'
                            }`}>
                        ...
                        <div>
                          ...
                          <div className={`text-lg font-bold ${perf.winRate >= 70 ? 'text-neon-green' : ''
                            }`}>
                        ...
                        <div>
                          ...
                          <div className={`text-lg font-bold ${perf.avgPnl > 0 ? 'text-neon-green' : 'text-neon-red'
                            }`}>
