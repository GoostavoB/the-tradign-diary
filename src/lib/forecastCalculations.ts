...
export const calculateAdvancedStats = (trades: Trade[]): AdvancedStats | null => {
  ...
  return {
    ...
    avg_margin,
    total_trades,
    daily_growth_base: daily_growth_base * 100,
    daily_growth_optimistic: daily_growth_optimistic * 100,
    daily_growth_conservative: daily_growth_conservative * 100,
    monthly_growth_base: calculateCompoundGrowth(daily_growth_base, 30) * 100,
    monthly_growth_optimistic: calculateCompoundGrowth(daily_growth_optimistic, 30) * 100,
    monthly_growth_conservative: calculateCompoundGrowth(daily_growth_conservative, 30) * 100,
    yearly_growth_base: calculateCompoundGrowth(daily_growth_base, 365) * 100,
    yearly_growth_optimistic: calculateCompoundGrowth(daily_growth_optimistic, 365) * 100,
    yearly_growth_conservative: calculateCompoundGrowth(daily_growth_conservative, 365) * 100,
    five_year_growth_base: calculateCompoundGrowth(daily_growth_base, 365 * 5) * 100,
    five_year_growth_optimistic: calculateCompoundGrowth(daily_growth_optimistic, 365 * 5) * 100,
    five_year_growth_conservative: calculateCompoundGrowth(daily_growth_conservative, 365 * 5) * 100,
  };
};
